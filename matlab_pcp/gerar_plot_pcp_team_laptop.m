...
M = csvread('8192_team_laptop_MATLAB.csv')
matrix = reshape (M, [8,8])
figure
...
title('{Rela\c{c}\~ao entre Processos MPI e Threads OpenMP para Algoritmo H\''ibrido :: Matriz 8192*8192 para TeamLaptop}','interpreter','latex')
xlabel('# Processos MPI');
ylabel('# Threads OpenMP por processo MPI');
